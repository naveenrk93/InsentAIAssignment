...
import {closeWidget} from "../actions";
    ...
    render(){
        return (
            <div className="chatbox-header">
                ...
                <i className="close inverted icon big" onClick={()=>{this.props.closeWidget()}}></i>
            </div>
        )
    }
}
...
export default connect(mapStateToProps, {closeWidget})(ChatboxHeader);
